...
const BRAND_LIST = ["88 Acres","Alani","Aloha","Anabar","Atlas","B.T.R. Nation","Barebells","Bob's Red Mill","Bobo's","Built","CLIF Bar","Clif Builders","Clif ZBar","Daryl's Bars","David","Epic","Equate","FITCRUNCH","Fiber One","Fulfil","GNC Total Lean","Gatorade","Ghost","Gryp","Honey Stinger","IQ Bar","Jacob","Jambar","Kize","Laird","Larabar","Legendary","Lineage Provisions","Luna","Mezcla","Mosh","Munk Pack","Mush","Nick's","No Cow","NuGo","One","PEAK Protein","PROBar","Perfect Bar","Possible","Power Crunch","Prima","Pure Protein","Quest","RXBAR","Raw Rev","Ready","Redefine","Rise","Send","Simply Protein","The Gluten Free Brothers","Trubar","Wonderslim","Zing","gomacro","think!"];
