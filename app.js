...
function openCompareOverlay() {
  ...
  // Calculate column width to fit within overlay without horizontal scroll
  const labelW = 100;
  const availW = Math.min(window.innerWidth - 24, 1000) - labelW;
  const barColW = Math.max(150, Math.floor(availW / colCount));
