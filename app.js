...
function readURLParams() {
  ...
  // grade — ?grade=A or legacy ?band=A
  const band = (params.get('grade') || params.get('band') || '').toUpperCase();
  if (band && ['A','B','C','D','F'].includes(band)) {
    activeGrade = band;
