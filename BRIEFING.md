...
**Remaining guide pages not yet refreshed against the new 1,245-bar database:** `no-sugar-alcohols.html`, `no-artificial-sweeteners.html`, `clean-protein-bars.html`, `keto-protein-bars.html`, `caffeine-protein-bars.html`. (`best-bars-for-diabetics.html` refreshed 2026-08-21, `no-seed-oils.html` refreshed 2026-08-23, see below.) Fresh filter counts against the new database (no page edits made yet, computed for planning only):
